...
<body style="background:royalblue;">
	...
	<div class="container">
		...
		<br />
		<br />
		<h3 align="center"><a href="https://www.configuroweb.com/" title="Para más desarrollos ConfiguroWeb" style="color:white;text-decoration:none;">Carro de compras</a></h3><br />
		<br /><br />
		<?php
		...
		?>
				<div class="col-md-4">
					<form method="post" action="index.php?action=add&id=<?php echo $row["id"]; ?>">
						<div style="border:1px solid #333; background-color:lightblue; border-radius:5px; padding:16px;" align="center">
